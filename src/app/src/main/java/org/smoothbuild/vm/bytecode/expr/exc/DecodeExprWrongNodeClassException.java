...
public class DecodeExprWrongNodeClassException extends DecodeExprNodeException {
  public DecodeExprWrongNodeClassException(Hash hash, CategoryB cat, String memberPath,
      int pathIndex, Class<?> expected, Class<?> actual) {
    this(hash, cat, indexedPath(memberPath, pathIndex), expected, actual);
  }

  public DecodeExprWrongNodeClassException(Hash hash, CategoryB cat, String path, Class<?> expected,
      Class<?> actual) {
