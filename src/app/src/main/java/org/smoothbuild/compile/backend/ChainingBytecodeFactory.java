...
class ChainingBytecodeFactory {
  ...
  public VarB var(TypeB evaluationT, BigInteger value) throws SbTranslatorException {
    return invokeTranslatingBytecodeException(() -> bytecodeF.var(evaluationT, value));
  }
