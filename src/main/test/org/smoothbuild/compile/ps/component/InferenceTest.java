  ...
  class _value {
    ...
    class _infer_mono_type_from {
      ...
      public void mono_func_ref() {
        ...
        module(code)
            .loadsWithSuccess()
            .containsEvaluableWithSchema("myValue", schemaS(funcTS(stringTS(), blobTS())));
      }
  ...
  class _func {
    ...
    class _infer_mono_func_result_type_from {
      ...
      public void param_func_call() {
        ...
        module(code)
            .loadsWithSuccess()
            .containsEvaluableWithSchema("myFunc", schemaS(funcTS(intTS(), funcTS(intTS()))));
      }
      ...
      public void mono_func_ref() {
        ...
        module(code)
            .loadsWithSuccess()
            .containsEvaluableWithSchema("myFunc", schemaS(funcTS(funcTS(stringTS(), blobTS()))));
      }
    ...
    class _infer_poly_func_result_type_from {
      ...
      class _func_ref {
        ...
        public void mono_func_ref() {
          ...
          module(code)
              .loadsWithSuccess()
              .containsEvaluableWithSchema("myFunc", funcSchemaS(funcTS(stringTS(), blobTS())));
        }
    ...
    class _infer_poly_func_call_type {
      ...
      class _with_default_type {
        ...
        public void test() {
          ...
          var call = callS(2, polyRefS(2, varMap(varA(), arrayTS(tupleTS())), myFunc),
