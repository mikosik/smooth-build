...
public class ObjectStableHashTest extends TestingContext {
  ...
  public void hash_of_non_empty_bool_array_is_stable() {
    Truth.assertThat(arrayBuilder(boolType()).add(bool(true)).build().hash())
  ...
  public void hash_of_non_empty_string_array_is_stable() {
    Truth.assertThat(arrayBuilder(stringType()).add(string("")).build().hash())
  ...
  public void hash_of_non_empty_blob_array_is_stable() {
    Truth.assertThat(arrayBuilder(blobType()).add(blob(ByteString.of())).build().hash())
  ...
  public void hash_of_non_empty_struct_array_is_stable() {
    Truth.assertThat(arrayBuilder(personType()).add(person("John", "Doe")).build().hash())
