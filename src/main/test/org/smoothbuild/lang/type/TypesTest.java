...
public class TypesTest {
  ...
  public static Suite is_arg_assignable_from() throws Exception {
    return suite("Type.isArgAssignableFrom").addAll(asList(
        ...
        illegalArgAssignment(type, person),
        ...
        allowedArgAssignment(string, person),
        ...
        illegalArgAssignment(blob, person),
        ...
        illegalArgAssignment(person, type),
        illegalArgAssignment(person, string),
        illegalArgAssignment(person, blob),
        allowedArgAssignment(person, person),
        allowedArgAssignment(person, nothing),
        illegalArgAssignment(person, a),
        illegalArgAssignment(person, arrayType),
        illegalArgAssignment(person, arrayString),
        illegalArgAssignment(person, arrayBlob),
        illegalArgAssignment(person, arrayPerson),
        illegalArgAssignment(person, arrayNothing),
        illegalArgAssignment(person, arrayA),
        illegalArgAssignment(person, array2Type),
        illegalArgAssignment(person, array2String),
        illegalArgAssignment(person, array2Blob),
        illegalArgAssignment(person, array2Person),
        illegalArgAssignment(person, array2Nothing),
        illegalArgAssignment(person, array2A),

        illegalArgAssignment(nothing, type),
        illegalArgAssignment(nothing, string),
        illegalArgAssignment(nothing, blob),
        illegalArgAssignment(nothing, person),
        ...
        illegalArgAssignment(arrayType, person),
        ...
        illegalArgAssignment(arrayString, person),
        ...
        illegalArgAssignment(arrayBlob, person),
        ...
        illegalArgAssignment(arrayPerson, person),
        ...
        illegalArgAssignment(arrayNothing, person),
        ...
        illegalArgAssignment(arrayA, person),
        ...
        illegalArgAssignment(array2Type, person),
        ...
        illegalArgAssignment(array2String, person),
        ...
        illegalArgAssignment(array2Blob, person),
        ...
        illegalArgAssignment(array2Person, person),
        ...
        illegalArgAssignment(array2Nothing, person),
        ...
        illegalArgAssignment(array2A, person),
