...
public class ObjectStableHashTest extends TestingContext {
  ...
  public void hash_of_true_bool_is_stable() throws Exception {
    ...
    when(bool).hash();
    thenReturned(Hash.decode("86ade1928ff1d0175a33d59080289212f79ff921"));
  }
  ...
  public void hash_of_false_bool_is_stable() throws Exception {
    ...
    when(bool).hash();
    thenReturned(Hash.decode("fe2c2d262ca0d3325738e492c11ef37523469d99"));
  }
  ...
  public void hash_of_empty_string_is_stable() throws Exception {
    ...
    when(sstring).hash();
    thenReturned(Hash.decode("0af6d4b68d3dadc04f1fd8d207702afd4809a0c2"));
  }
  ...
  public void hash_of_some_string_is_stable() throws Exception {
    ...
    when(sstring).hash();
    thenReturned(Hash.decode("4d3465c4280a64e3a6c2272fc48e971d102eac93"));
  }
  ...
  public void hash_of_empty_blob_is_stable() throws Exception {
    ...
    when(() -> blob.hash());
    thenReturned(Hash.decode("6915b0de6d40fc94df5c229b46da15e34d7c232b"));
  }
  ...
  public void hash_of_some_blob_is_stable() throws Exception {
    ...
    when(() -> blob.hash());
    thenReturned(Hash.decode("72ae3804e4c12bbd45e26440e9817a5bf3ca0811"));
  }
  ...
  public void hash_of_empty_bool_array_is_stable() throws Exception {
    ...
    when(() -> array.hash());
    thenReturned(Hash.decode("ddc07c59607a4a56f2d34b6cc8fef9459c51f3f3"));
  }
  ...
  public void hash_of_non_empty_bool_array_is_stable() throws Exception {
    ...
    when(() -> array.hash());
    thenReturned(Hash.decode("394b5eddb75a2279b8fcf4ab238d8d0258cdac39"));
  }
  ...
  public void hash_of_empty_string_array_is_stable() throws Exception {
    ...
    when(() -> array.hash());
    thenReturned(Hash.decode("b2d4a44801204a93da825d1b4db4ef4af2787d82"));
  }
  ...
  public void hash_of_non_empty_string_array_is_stable() throws Exception {
    ...
    when(() -> array.hash());
    thenReturned(Hash.decode("98370fae56927d0832578f133ca73ff1f58fe415"));
  }
  ...
  public void hash_of_empty_blob_array_is_stable() throws Exception {
    ...
    when(() -> array.hash());
    thenReturned(Hash.decode("000c25ccefc9fbd916400c36eb99bd2610f507ea"));
  }
  ...
  public void hash_of_non_empty_blob_array_is_stable() throws Exception {
    ...
    when(() -> array.hash());
    thenReturned(Hash.decode("3dd2f9efc115cc922304f91df183bc8359df9ec8"));
  }
  ...
  public void hash_of_empty_struct_array_is_stable() throws Exception {
    ...
    when(() -> array.hash());
    thenReturned(Hash.decode("21187af9783689f62abc2f1e10fb76233d167af8"));
  }
  ...
  public void hash_of_non_empty_struct_array_is_stable() throws Exception {
    ...
    when(() -> array.hash());
    thenReturned(Hash.decode("28c181c073e198d5ca5f233ac682a7a09f0aeb63"));
  }
  ...
  public void hash_of_empty_nothing_array_is_stable() throws Exception {
    ...
    when(() -> array.hash());
    thenReturned(Hash.decode("034da224a1b3f7e2d2702ce8c5dd986f11b9b08a"));
  }
}
