...
public class TypeTest {
  ...
  public void commonSuperType(Type type1, Type type2, Type expected) {
  ...
  public static List<Arguments> commonSuperType_test_data() {
    return List.of(
        arguments(type, type, type),
        arguments(type, bool, null),
        arguments(type, string, null),
        arguments(type, blob, null),
        arguments(type, nothing, type),
        arguments(type, a, null),
        arguments(type, arrayType, null),
        arguments(type, arrayBool, null),
        arguments(type, arrayString, null),
        arguments(type, arrayBlob, null),
        arguments(type, arrayNothing, null),
        arguments(type, arrayA, null),

        arguments(bool, string, null),
        arguments(bool, bool, bool),
        arguments(bool, blob, null),
        arguments(bool, nothing, bool),
        arguments(bool, a, null),
        arguments(bool, arrayString, null),
        arguments(bool, arrayBool, null),
        arguments(bool, arrayType, null),
        arguments(bool, arrayBlob, null),
        arguments(bool, arrayNothing, null),
        arguments(bool, arrayA, null),

        arguments(string, string, string),
        arguments(string, blob, null),
        arguments(string, nothing, string),
        arguments(string, a, null),
        arguments(string, arrayString, null),
        arguments(string, arrayBool, null),
        arguments(string, arrayType, null),
        arguments(string, arrayBlob, null),
        arguments(string, arrayNothing, null),
        arguments(string, arrayA, null),

        arguments(blob, blob, blob),
        arguments(blob, nothing, blob),
        arguments(blob, a, null),
        arguments(blob, arrayType, null),
        arguments(blob, arrayString, null),
        arguments(blob, arrayBlob, null),
        arguments(blob, arrayNothing, null),
        arguments(blob, arrayA, null),
        ...
        arguments(a, a, a),
        arguments(a, b, null),
        arguments(a, arrayType, null),
        arguments(a, arrayString, null),
        arguments(a, arrayBlob, null),
        arguments(a, arrayNothing, null),
        arguments(a, arrayA, null),
        arguments(a, arrayB, null),

        arguments(arrayType, arrayType, arrayType),
        arguments(arrayType, arrayString, null),
        arguments(arrayType, arrayBlob, null),
        arguments(arrayType, arrayNothing, arrayType),
        arguments(arrayType, arrayA, null),

        arguments(arrayString, arrayString, arrayString),
        arguments(arrayString, arrayBlob, null),
        arguments(arrayString, arrayNothing, arrayString),
        arguments(arrayString, nothing, arrayString),
        arguments(arrayString, arrayA, null),

        arguments(arrayBlob, arrayBlob, arrayBlob),
        arguments(arrayBlob, arrayNothing, arrayBlob),
        arguments(arrayBlob, nothing, arrayBlob),
        arguments(arrayBlob, arrayA, null),

        arguments(arrayNothing, arrayNothing, arrayNothing),
        arguments(arrayNothing, array2Nothing, array2Nothing),
        arguments(arrayNothing, arrayType, arrayType),
        arguments(arrayNothing, arrayString, arrayString),
        arguments(arrayNothing, arrayBlob, arrayBlob),
        arguments(arrayNothing, arrayA, arrayA),

        arguments(arrayA, arrayA, arrayA),
        arguments(arrayA, arrayB, null));
  }
