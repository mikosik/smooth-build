...
import static org.smoothbuild.lang.base.type.TestingTypes.array2Type;
...
import static org.smoothbuild.lang.base.type.TestingTypes.arrayType;
...
import static org.smoothbuild.lang.base.type.TestingTypes.type;
...
public class TypeTest {
  ...
  public static List<Arguments> commonSuperType_test_data() {
    return List.of(
        ...
        arguments(bool, bool, Optional.of(
                bool)),
        arguments(bool, blob, Optional.empty()),
        arguments(bool, nothing, Optional.of(
                bool)),
        ...
        arguments(string, string, Optional.of(
                string)),
        arguments(string, blob, Optional.empty()),
        arguments(string, nothing, Optional.of(
                string)),
        ...
        arguments(blob, blob, Optional.of(
                blob)),
        arguments(blob, nothing, Optional.of(
                blob)),
        ...
        arguments(nothing, nothing, Optional.of(
                nothing)),
        arguments(nothing, a, Optional.of(
                a)),
        arguments(nothing, arrayType, Optional.of(
                arrayType)),
        arguments(nothing, arrayString, Optional.of(
                arrayString)),
        arguments(nothing, arrayBlob, Optional.of(
                arrayBlob)),
        arguments(nothing, arrayNothing, Optional.of(
                arrayNothing)),
        arguments(nothing, arrayA, Optional.of(
                arrayA)),

        arguments(a, a, Optional.of(
                a)),
        ...
        arguments(arrayType, arrayType, Optional.of(
                arrayType)),
        arguments(arrayType, arrayString, Optional.empty()),
        arguments(arrayType, arrayBlob, Optional.empty()),
        arguments(arrayType, arrayNothing, Optional.of(
                arrayType)),
        arguments(arrayType, arrayA, Optional.empty()),

        arguments(arrayString, arrayString, Optional.of(
                arrayString)),
        arguments(arrayString, arrayBlob, Optional.empty()),
        arguments(arrayString, arrayNothing, Optional.of(
                arrayString)),
        arguments(arrayString, nothing, Optional.of(
                arrayString)),
        arguments(arrayString, arrayA, Optional.empty()),

        arguments(arrayBlob, arrayBlob, Optional.of(
                arrayBlob)),
        arguments(arrayBlob, arrayNothing, Optional.of(
                arrayBlob)),
        arguments(arrayBlob, nothing, Optional.of(
                arrayBlob)),
        arguments(arrayBlob, arrayA, Optional.empty()),

        arguments(arrayNothing, arrayNothing, Optional.of(
                arrayNothing)),
        arguments(arrayNothing, array2Nothing, Optional.of(
                array2Nothing)),
        arguments(arrayNothing, arrayType, Optional.of(
                arrayType)),
        arguments(arrayNothing, arrayString, Optional.of(
                arrayString)),
        arguments(arrayNothing, arrayBlob, Optional.of(
                arrayBlob)),
        arguments(arrayNothing, arrayA, Optional.of(
                arrayA)),

        arguments(arrayA, arrayA, Optional.of(
                arrayA)),
