...
public class AlgorithmHashesCollisionTest extends TestingContext {
  ...
  public void each_algorithm_has_different_hash() {
    ...
    addHash(list, set, AlgorithmHashes.combineAlgorithmHash(tupleTB(list())));
    addHash(list, set, AlgorithmHashes.combineAlgorithmHash(tupleTB(list(intTB()))));
    addHash(list, set, AlgorithmHashes.combineAlgorithmHash(tupleTB(list(stringTB()))));
    addHash(list, set, AlgorithmHashes.combineAlgorithmHash(tupleTB(list(intTB(), stringTB()))));
