...
public class SpecStableHashTest extends TestingContext {
  ...
  public void hashes_of_specs_are_stable() {
    ...
    assertHash(tupleSpec(objectDb()), "5dd814fefb53a67d3fd0ec7fadcca7e1aa9d9b3b");
  }

  private TupleSpec tupleSpec(ObjectDb objectDb) {
    return objectDb.tupleSpec(list(objectDb.stringSpec(), objectDb.blobSpec()));
  }
