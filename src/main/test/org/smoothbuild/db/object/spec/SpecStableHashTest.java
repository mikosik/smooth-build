...
public class SpecStableHashTest extends TestingContextImpl {
  ...
  public void hashes_of_specs_are_stable() {
    ...
    assertHash(stringSpec(), "5ac99f914f66deae94b7b0d990e821fe2117cf61");
    ...
    assertHash(arraySpec(stringSpec()), "dfeac8190688130683d51d719055d46c47cec4d2");
    ...
    assertHash(orderSpec(intSpec()), "04c4786e96bdac890b5089eee99173cd41cecb33");
