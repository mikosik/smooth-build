...
public class SpecStableHashTest extends TestingContext {
  ...
  public void hashes_of_specs_are_stable() {
    ...
    assertHash(definedLambdaSpec(), "d544e7163e43d4c81f530518c02fee1aeb6f7643");
    assertHash(intSpec(), "8be891c7170d4d1bbca0ffcb3fce71285c55aee4");
    assertHash(nativeLambdaSpec(), "d47e3d353022725ed799cea636a8880a664372a7");
    ...
    assertHash(arraySpec(definedLambdaSpec()), "af8cc230d0308447f54838e7551fe029c9f6b13d");
    assertHash(arraySpec(intSpec()), "ff10a58462549d6f2a55c51be139ae52b62bf801");
    assertHash(arraySpec(nativeLambdaSpec()), "52ffb1e743837eadc04203f060bb07764afa9e9d");
