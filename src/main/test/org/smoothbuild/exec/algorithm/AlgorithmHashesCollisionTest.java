...
public class AlgorithmHashesCollisionTest extends TestingContext {
  ...
  public void each_algorithm_has_different_hash() {
    ...
    addHash(list, set, constAlgorithmHash(arrayH(blobHT())));
    ...
    addHash(list, set, constAlgorithmHash(arrayH(boolHT())));
    ...
    addHash(list, set, constAlgorithmHash(arrayH(intHT())));
    addHash(list, set, constAlgorithmHash(arrayH(intH(0))));
    addHash(list, set, constAlgorithmHash(arrayH(stringHT())));
    ...
    addHash(list, set, combineAlgorithmHash(tupleHT(list())));
    addHash(list, set, combineAlgorithmHash(tupleHT(list(intHT()))));
    addHash(list, set, combineAlgorithmHash(tupleHT(list(stringHT()))));
    addHash(list, set, combineAlgorithmHash(tupleHT(list(intHT(), stringHT()))));
