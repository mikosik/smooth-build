...
public class DecodeConstructWrongItemsSizeException extends DecodeObjException {
  public DecodeConstructWrongItemsSizeException(Hash hash, ConstructTypeO type, int actual) {
    super(buildMessage(hash, type, actual));
  }

  private static String buildMessage(Hash hash, ConstructTypeO type, int actual) {
