...
public class DecodeObjNodeException extends DecodeObjException {
  public DecodeObjNodeException(Hash hash, SpecH type, String path, String message) {
    super(buildMessage(hash, type, path, message));
  }

  public DecodeObjNodeException(Hash hash, SpecH type, String path) {
    super(buildMessage(hash, type, path, null));
  }

  public DecodeObjNodeException(Hash hash, SpecH type, String path, Throwable e) {
