...
public class DecodeSelectWrongEvaluationTypeException extends DecodeObjException {
  public DecodeSelectWrongEvaluationTypeException(Hash hash, SelectTypeO type, TypeV actual) {
    super(buildMessage(hash, type, actual));
  }

  private static String buildMessage(Hash hash, SelectTypeO type, TypeV actual) {
