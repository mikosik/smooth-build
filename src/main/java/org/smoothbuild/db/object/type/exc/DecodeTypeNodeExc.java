...
public class DecodeTypeNodeExc extends DecodeTypeExc {
  public DecodeTypeNodeExc(Hash hash, SpecKindH kind, String path, String message) {
    super(buildMessage(hash, kind, path, message));
  }

  public DecodeTypeNodeExc(Hash hash, SpecKindH kind, String path) {
    super(buildMessage(hash, kind, path, null));
  }

  public DecodeTypeNodeExc(Hash hash, SpecKindH kind, String path, int index, Throwable e) {
    this(hash, kind, path + "[" + index + "]", e);
  }

  public DecodeTypeNodeExc(Hash hash, SpecKindH kind, String path, Throwable e) {
