...
import org.smoothbuild.exec.compute.ApplyJob;
import org.smoothbuild.exec.compute.DefaultArgumentJob;
import org.smoothbuild.exec.compute.IfJob;
import org.smoothbuild.exec.compute.Job;
import org.smoothbuild.exec.compute.LazyJob;
import org.smoothbuild.exec.compute.MapJob;
import org.smoothbuild.exec.compute.Task;
import org.smoothbuild.exec.compute.TaskInfo;
import org.smoothbuild.exec.compute.VirtualJob;
...
public class JobCreator {
  ...
  private static Optional<ArrayType> arrayType(List<Job> elements) {
    return elements
        .stream()
        .map(Job::type)
