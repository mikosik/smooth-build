...
import org.smoothbuild.task.work.NativeCallWorkerLegacy;
import org.smoothbuild.task.work.TaskWorker;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableMap;

public class NativeCallExpressionLegacy extends Expression {
  private final Function function;
  private final boolean isGenerated;
  private final ImmutableMap<String, ? extends Expression> args;

  public NativeCallExpressionLegacy(NativeFunctionLegacy function, boolean isGenerated,
  ...
  public TaskWorker createWorker() {
    ...
    return new NativeCallWorkerLegacy(nativeFunction, parameterNames, isGenerated, codeLocation());
  }
}
