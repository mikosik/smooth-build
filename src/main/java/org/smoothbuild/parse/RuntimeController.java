...
public class RuntimeController {
  ...
  @Inject
  public RuntimeController(SRuntime runtime, ModuleLoader moduleLoader, SmoothPaths paths,
      Console console) {
  ...
  public int setUpRuntimeAndRun(Consumer<SRuntime> runner) {
    List<? extends Object> errors = value(moduleLoader)
        .invoke(ml -> ml.loadModule(runtime, paths.funcsModule()))
        .invoke(ml -> ml.loadModule(runtime, paths.defaultScript()))
