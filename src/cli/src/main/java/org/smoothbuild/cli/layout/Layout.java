...
public class Layout {
  ...
  public static final FullPath PROJECT_PATH = PROJECT_ALIAS.path(Path.root());
  ...
  public static final FullPath DEFAULT_MODULE_FILE_PATH = PROJECT_ALIAS.path(DEFAULT_MODULE_PATH);
  public static final FullPath STD_LIB_MODULE_PATH = LIBRARY_ALIAS.path(path("std_lib.smooth"));
