...
public class TasksTest {
  ...
  void task1_invokes_function() {
    ...
    assertThat(mapTask.execute("abc")).isEqualTo(output("abc!", report(label)));
  }
  ...
  void task2_invokes_function() {
    ...
    assertThat(mapTask.execute("abc", "def")).isEqualTo(output("abcdef", report(label)));
  }
  ...
  void taskX_invokes_function() {
    ...
    assertThat(mapTask.execute(list("a", "b", "c"))).isEqualTo(output("a,b,c", report(label)));
  }
}
