...
public class FileClassLoader extends ClassLoader {
  private final Map<String, TupleH> binaryNameToFile;

  public FileClassLoader(Map<String, TupleH> binaryNameToFile) {
  ...
  public Class<?> findClass(String name) throws ClassNotFoundException {
    TupleH file = binaryNameToFile.get(name);
    if (file == null) {
  ...
  private byte[] fileToByteArray(TupleH file) throws IOException {
