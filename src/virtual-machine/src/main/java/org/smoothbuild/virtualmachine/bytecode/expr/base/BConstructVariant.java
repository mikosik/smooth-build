 ...
 */
public final class BConstructVariant extends BOperation {
  ...
  public BConstructVariant(MerkleRoot merkleRoot, BExprDb exprDb) {
  ...
  @Override
  public BConstructVariantKind kind() {
    return (BConstructVariantKind) super.kind();
  }
