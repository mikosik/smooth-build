 ...
 * Category of BExpr.
 */
public abstract class BCategory {
  private final Hash hash;
  private final String name;
  private final Class<? extends BExpr> javaType;

  protected BCategory(Hash hash, String name, Class<? extends BExpr> javaType) {
    this.hash = hash;
    this.name = name;
  ...
  public abstract BExpr newExpr(MerkleRoot merkleRoot, ExprDb exprDb)
      throws DecodeIllegalCategoryException;

  @Override
  public boolean equals(Object object) {
    return (object instanceof BCategory that) && Objects.equals(hash(), that.hash());
  }
