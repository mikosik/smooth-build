...
public class TupleGetHasWrongEvaluationTypeException extends DecodeExprException {
  public TupleGetHasWrongEvaluationTypeException(Hash hash, BTupleGetKind kind, BType actual) {
    super(buildMessage(hash, kind, actual));
  }

  private static String buildMessage(Hash hash, BTupleGetKind kind, BType actual) {
