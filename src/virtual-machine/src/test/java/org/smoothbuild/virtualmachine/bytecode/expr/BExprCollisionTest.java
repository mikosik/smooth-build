...
public class BExprCollisionTest extends VmTestContext {
  ...
  private List<BExpr> exprBs() throws Exception {
    ...
    return List.of(
        ...
        bCreateVariant(bVariantType(), bInt(0), bString("7")),
        bCreateVariant(bVariantType(), bInt(1), bInt(7)),
        bSwitch(bVariant(), bCreateTuple(bs2iLambda(), bi2iLambda(1))),
        ...
        bCreateArray(bIntType(), bInt(1)),
        bCreateArray(bIntType(), bInt(2)),
        bCreateArray(bIntArrayType(), bArray(bIntType())),
