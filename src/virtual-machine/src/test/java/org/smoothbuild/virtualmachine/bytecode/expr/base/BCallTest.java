...
public class BCallTest extends VmTestContext {
  ...
  void member_getters_returns_members() throws Exception {
    ...
    assertThat(call.arguments()).isEqualTo(bConstructTuple(argument));
  }
  ...
  void call_read_back_by_hash_has_same_data() throws Exception {
    ...
    assertThat(callRead.arguments()).isEqualTo(bConstructTuple(argument));
  }
  ...
  void to_string() throws Exception {
    ...
    assertThat(call.toString()).isEqualTo("""
        BCall(
