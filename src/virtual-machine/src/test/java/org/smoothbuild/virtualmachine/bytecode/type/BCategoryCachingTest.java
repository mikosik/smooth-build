...
public class BCategoryCachingTest extends TestingVirtualMachine {
  @ParameterizedTest
  @MethodSource("factories")
  public void created_type_is_cached(Function1<CategoryDb, BCategory, BytecodeException> factory)
      throws Exception {
  ...
  @ParameterizedTest
  @MethodSource("factories")
  public void read_type_is_cached(Function1<CategoryDb, BCategory, BytecodeException> factory)
      throws Exception {
  ...
  private static java.util.List<Function1<CategoryDb, BCategory, BytecodeException>> factories() {
    return list(
        CategoryDb::blob,
        CategoryDb::bool,
        BCategoryCachingTest::funcT,
        CategoryDb::int_,
        CategoryDb::string,
        BCategoryCachingTest::tupleT,
  ...
  private static BTupleType tupleT(CategoryDb categoryDb) throws BytecodeException {
    return categoryDb.tuple(categoryDb.string(), categoryDb.string());
  }

  private static BFuncType funcT(CategoryDb categoryDb) throws BytecodeException {
