...
public class ComputationHashFactoryTest extends VmTestContext {
  ...
  void hashes_of_computations_with_same_evaluator_sandbox_and_input_are_equal() throws Exception {
    var evaluator = new BOrderEvaluator(bOrder(), trace());
    var input = bTuple(bString("input"));
    assertThat(create(Hash.of(13), evaluator, input))
        .isEqualTo(create(Hash.of(13), evaluator, input));
  }

  @Test
  void hashes_of_computations_with_different_evaluator_but_same_sandbox_and_input_are_not_equal()
      throws Exception {
    var evaluator1 = new BOrderEvaluator(bOrder(bInt()), trace());
    var evaluator2 = new BOrderEvaluator(bOrder(bString()), trace());
    var input = bTuple(bString("input"));
    assertThat(create(Hash.of(13), evaluator1, input))
        .isNotEqualTo(create(Hash.of(13), evaluator2, input));
  }
  ...
  void hashes_of_computations_with_same_evaluator_and_input_but_different_sandbox_are_not_equal()
    ...
    var input = bTuple(bString("input"));
    assertThat(create(Hash.of(13), evaluator, input))
        .isNotEqualTo(create(Hash.of(14), evaluator, input));
  }
  ...
  void hashes_of_computations_with_same_evaluator_sandbox_but_different_input_are_not_equal()
    ...
    assertThat(create(Hash.of(13), evaluator, input1))
        .isNotEqualTo(create(Hash.of(13), evaluator, input2));
  }
  ...
  class _computation_hash_is_stable_for {
    ...
    void combine_evaluator_and_empty_input() throws Exception {
      var evaluator = new BCombineEvaluator(bCombine(), trace());
      var input = bTuple();
      assertThat(create(Hash.of(13), evaluator, input))
          .isEqualTo(
    ...
    void order_evaluator_and_empty_input() throws Exception {
      var evaluator = new BOrderEvaluator(bOrder(bStringType()), trace());
      var input = bTuple();
      assertThat(create(Hash.of(13), evaluator, input))
          .isEqualTo(
    ...
    void pick_evaluator() throws Exception {
      var evaluator = new BPickEvaluator(bPick(bArray(bInt(37)), bInt(0)), trace());
      var input = bTuple();
      assertThat(create(Hash.of(13), evaluator, input))
          .isEqualTo(
