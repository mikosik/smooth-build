...
public class BCategoryStableHashTest extends TestingVirtualMachine {
  @ParameterizedTest
  @MethodSource("hash_is_stable_cases")
  public void hash_is_stable(BCategory category, String hash) {
    assertThat(category.hash()).isEqualTo(Hash.decode(hash));
  }
  ...
  public static List<Arguments> hash_is_stable_cases() throws BytecodeException {
    ...
    return List.of(
        ...
        arguments(t.lambdaCB(), "6bc8397b7832905afad31d92d07c1d21f1302196b142d0b004549aec72962c07"),
        arguments(t.funcTB(), "2efc8dc079b8693ac751fc181888b64bb53404b0c1aba4c54f9dafbe2e1ec254"),
        arguments(t.ifFuncCB(), "f784ebe7e358cf4dee4455464bf48ed13e2b93d1d4d9d1068aae8b6a27ff95c4"),
        arguments(t.intTB(), "1cc3adea40ebfd94433ac004777d68150cce9db4c771bc7de1b297a7b795bbba"),
        arguments(
            t.mapFuncCB(), "21f8080bd94cf983b9082f0600b7eee7bbd93079ac0e736a966bfafb06089475"),
        arguments(
            t.nativeFuncCB(), "338de86e29bcefc852824d0885e1aeab93a87a86018176359c947693448a3bce"),
        arguments(t.stringTB(), "c942a06c127c2c18022677e888020afb174208d299354f3ecfedb124a1f3fa45"),
        arguments(
            t.tupleTB(t.blobTB()),
        ...
        arguments(
            t.combineCB(), "c41cd9d13e32154103a31db858ba533bbcb38fe2c2ddac7c5e4a0be50201083b"),
        arguments(
            t.combineCB(t.intTB()),
