...
public class TupleGetHasWrongEvaluationTypeExceptionTest extends VmTestContext {
  @Test
  void message() throws Exception {
    var exception = new TupleGetHasWrongEvaluationTypeException(
        Hash.of(13), bTupleGetKind(bIntType()), bStringType());
