...
public class BCategoryTest extends TestingVirtualMachine {
  @ParameterizedTest
  @MethodSource("names")
  public void name(Function1<CategoryDb, BCategory, BytecodeException> factoryCall, String name)
      throws Exception {
  ...
  public void quoted_name(
      Function1<CategoryDb, BCategory, BytecodeException> factoryCall, String name)
      throws Exception {
  ...
  class _func {
    ...
    public void result(
        Function1<CategoryDb, BFuncType, BytecodeException> factoryCall,
        Function1<CategoryDb, java.util.List<BType>, BytecodeException> expected)
        throws Exception {
  ...
  class _lambda {
    ...
    @MethodSource("result_cases")
    public void result(
        Function1<CategoryDb, BLambdaCategory, BytecodeException> factoryCall,
        Function1<CategoryDb, java.util.List<BType>, BytecodeException> expected)
        throws Exception {
  ...
  class _native_func {
    ...
    @MethodSource("result_cases")
    public void result(
        Function1<CategoryDb, BNativeFuncCategory, BytecodeException> factoryCall,
        Function1<CategoryDb, java.util.List<BType>, BytecodeException> expected)
        throws Exception {
      assertThat(execute(factoryCall).type().result()).isEqualTo(execute(expected));
    }
  ...
  class _array {
    ...
    public void elemType(Function1<CategoryDb, BType, BytecodeException> factoryCall)
        throws Exception {
      var elementType = execute(factoryCall);
      var arrayType = categoryDb().array(elementType);
  ...
  class _tuple {
    ...
    public void tuple_items(
        Function1<CategoryDb, BTupleType, BytecodeException> factoryCall,
        Function1<CategoryDb, List<BType>, BytecodeException> expected)
        throws Exception {
  ...
  public void typeJ(BCategory type, Class<?> expected) throws Exception {
  ...
  class _oper {
    ...
    public void combine(BCombineCategory type, BTupleType expected) throws Exception {
    ...
    public static List<BCategory> types() {
