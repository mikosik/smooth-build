...
public class HelpCommandTest extends AcceptanceTestCase {
  ...
  private static String expectedBuildCommandHelp() {
    return unlines(
        ...
        "",
        "                            Filter is a boolean expression built using built-in",
        "                              matchers (listed below), boolean operators '&',",
        "                              '|', brackets '(', ')'.",
        ...
        "                              tasks that have at least one error log and for",
        "                              each such task all logs with at least warning",
        "                              level.",
        "",
