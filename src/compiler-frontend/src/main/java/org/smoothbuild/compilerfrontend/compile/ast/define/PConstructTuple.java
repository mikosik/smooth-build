...
public final class PConstructTuple extends PExpr {
  private final List<PExpr> elements;

  public PConstructTuple(List<PExpr> elements, Location location) {
    super(location);
  ...
  public boolean equals(Object object) {
    ...
    return object instanceof PConstructTuple that
  ...
  public String toString() {
    return new ToStringBuilder("PConstructTuple")
