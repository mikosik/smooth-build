...
public final class PCreateArray extends PExpr {
  private final List<PExpr> elements;

  public PCreateArray(List<PExpr> elements, Location location) {
    super(location);
  ...
  public boolean equals(Object object) {
    ...
    return object instanceof PCreateArray that
  ...
  public String toString() {
    return new ToStringBuilder("PCreateArray")
