...
public final class PCreateTuple extends PExpr {
  private final List<PExpr> elements;

  public PCreateTuple(List<PExpr> elements, Location location) {
    super(location);
  ...
  public boolean equals(Object object) {
    ...
    return object instanceof PCreateTuple that
  ...
  public String toString() {
    return new ToStringBuilder("PCreateTuple")
