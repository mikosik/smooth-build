...
public class TestingSpecs {
  ...
  public static final RecordDb OBJECT_DB = CONTEXT.recordDb();
  public static final Spec SPEC = OBJECT_DB.specSpec();
  ...
  public static final ArraySpec ARRAY_SPEC = array(SPEC);
  ...
  public static final ArraySpec ARRAY2_SPEC = array(ARRAY_SPEC);
