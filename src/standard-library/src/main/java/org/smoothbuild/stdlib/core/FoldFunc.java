...
public class FoldFunc {
  public static BValue bytecode(BytecodeFactory f, Map<String, BType> varMap)
    ...
    var initialParamReference = f.paramRef(initialParamType, f.int_(BigInteger.TWO));
    var folderParamReference = f.paramRef(folderParamType, f.int_(BigInteger.valueOf(3)));
